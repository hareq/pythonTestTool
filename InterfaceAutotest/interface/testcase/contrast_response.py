...
from interface.lib.httpbase import http


def Language_result(bb):
    aa = urllib.quote(bb)
    url1 = 'http://10.8.91.243:8180/appautocomplete/search?keyword='+aa+'&action=autocomplete&source=globalapp65&lon=121.35801673&lat=31.22016018&districtid=2&type=fortest'
    ...
    #content1 = content1.replace("url","urlgu")
...
start()
# a = urllib2.urlopen("http://10.2.25.24:8180/appautocomplete/search?keyword=shangai&action=autocomplete&source=globalapp65&districtid=360&lon=121.575114&lat=25.036473")
# a = a.read()
